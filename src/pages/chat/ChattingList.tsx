    ...
    <div className="h-[100%]">
      <div>
        {data?.map((item: IChatList) => (
          <div className="w-[370px] h-[100px] p-3 flex items-center justify-between bg-white rounded-lg border-b-4 border-r-4 shadow-lg mt-3">
            <img
            ...
            <div className="flex justify-end m-auto">
              <img
                className="rounded-xl w-[60px] h-[60px] mr-[15px]"
                src={item.item_image}
              />
