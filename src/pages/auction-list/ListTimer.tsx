        ...
        {remainingTime !== 0 ? (
          <div className="flex justify-between">
            ...
            {duration.hours() <= 12 && days <= 0 ? (
              <div className="bg-red-500 text-white -mt-[210px] ml-[203px] px-3 w-16 h-16 flex flex-col items-center justify-center text-xs rounded-full shadow-md font-semibold">
                {format}
              </div>
            ) : (
              <div className="bg-green-500 text-gray-800 -mt-[210px] ml-[203px] px-[10px] w-16 h-16 flex flex-col items-center justify-center text-xs rounded-full shadow-md font-semibold">
                {format}
              </div>
            )}
          </div>
