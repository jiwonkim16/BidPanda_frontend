...
|이름|역할|구현 기능|Contect|
|:-----:|:-----:|:------------|:-----|
|김고야|`LEAD`<br>`BE`|경매 상품(등록, 조회<querydsl 동적쿼리 적용>, 입찰)<br>경매 종료시 판매자와 낙찰자에게 SSE 알림 발송 ( Cron-Job에서 호출시)<br>알림 목록 조회<br>이미지 관리 AWS S3( 프로필 이미지, 상품 이미지)<br>회원탈퇴(Soft Delete)<br>응답 포맷 형식,<br>CI/CD<br>Swagger적용|📧 ksw270@gmail.com<br>✨ [https://github.com/dewey-89](https://github.com/dewey-89)|
|김지원|`FE`|SSE 알림,<br>단일 알람 조회 및 읽음 처리,<br>경매종료 30분 전 알람 SSE 전송 기능, 알람 삭제,<br>찜 알람 기능,<br>상품 수정 및 삭제 기능,<br>상품 찜하기 및 취소 기능,<br>마이페이지 조회 기능(사용자 입찰 물품, 찜한 물품, 경매 등록 물품 조회),<br>CI/CD, 글로벌 예외처리 적용|📧 ktera1231@gmail.com<br>✨[https://github.com/byunggwan-Kim](https://github.com/byunggwan-Kim)
